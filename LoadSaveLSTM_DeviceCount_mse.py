...
yaml_file = open('model_device_stateful_1_mse.yaml', 'r')
loaded_model_yaml = yaml_file.read()
yaml_file.close()
loaded_model = model_from_yaml(loaded_model_yaml)
# load weights into new model
loaded_model.load_weights("model_device_stateful_1_mse.h5")
...
print(inv_yhat)
where_are_NaNs = np.isnan(inv_yhat)
inv_yhat[where_are_NaNs] = -1
...
combined.to_csv("/users/charan/predicted_device_1722_1440_mse.csv", sep=',')
