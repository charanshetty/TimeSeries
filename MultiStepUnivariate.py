#univariate analysis for multistep , 
...
n_lag = 1
n_seq = 12
n_test = 12 #test for future. some
n_epochs = 1500
n_batch = 1
n_neurons = 1
# prepare data
...
with open("model_uni.yaml", "w") as yaml_file:
    yaml_file.write(model_yaml)
# serialize weights to HDF5
model.save_weights("model_uni.h5")
